...
public class MPIcon extends ImageIcon {
    ...
    public static String DIRECTORY_DEFAULT_ICONS = "/images/22/mimetypes/";
    public static Icon ICON_ENABLED = new javax.swing.ImageIcon(MPIcon.class.getResource("/images/16/yes.png"));
    public static Icon ICON_DISABLED = new javax.swing.ImageIcon(MPIcon.class.getResource("/images/16/remove.png"));
