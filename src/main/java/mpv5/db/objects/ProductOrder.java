...
public class ProductOrder extends DatabaseObject implements Formattable, Templateable {
    ...
    public mpv5.utils.images.MPIcon getIcon() {
        switch (getIntstatus()) {
            case Item.STATUS_QUEUED:
                return new MPIcon("/images/22/kontact_mail.png");
            case Item.STATUS_IN_PROGRESS:
                return new MPIcon("/images/22/run.png");
            case Item.STATUS_PAUSED:
                return new MPIcon("/images/22/kalarm.png");
            case Item.STATUS_FINISHED:
                return new MPIcon("/images/22/knewstuff.png");
            case Item.STATUS_PAID:
                return new MPIcon("/images/22/ok.png");
            case Item.STATUS_CANCELLED:
                return new MPIcon("/images/22/file_temporary.png");
            default:
                return new MPIcon("/images/22/kontact_mail.png");
        }
    }
